...
- 2024.12 ~ 2025.02 LG전자 Dx School
- 2025.02 ~ 현재 NC AI AI Researcher (AI 데이터팀)


## 👨‍💻 Main Project

| 프로젝트 이미지                          | 프로젝트 이름 | 기간                      | 역할                | 내용                     |
|--------------------------------------|-----------------------------|-------------------------|-------------------|------------------------|
...
| <img src="https://github.com/ejehoon/LG_DX_School/blob/main/img/LG%EC%A0%84%EC%9E%90%EB%A1%9C%EA%B3%A0.png" width="90"> | [🔧 LG전자 DX School](https://github.com/ejehoon/LG_DX_School/tree/main) | 2024.12 ~ 진행 중 | 기획 학습, BX 프로젝트 | 데이터 기반 고객 경험 중심 기획 학습 |
